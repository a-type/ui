...
export const tipTapClassName = clsx(
	...
	'layer-components:[&_h1]:(text-2xl font-semibold mb-md mt-xl)',
	'layer-components:[&_h2]:(text-lg font-bold color-gray-dark color-darken-7 mb-md mt-lg)',
	'layer-components:[&_h3]:(text-md font-500 color-gray-dark color-darken-5 mb-sm mt-md)',
	'layer-components:[&_h4]:(text-xs color-gray-dark color-darken-3 mb-sm mt-md uppercase)',
