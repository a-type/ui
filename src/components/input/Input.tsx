...
const inputBorderClassName = clsx(
	...
	'layer-components:([--global-shadow-spread:0] flex flex-row items-center gap-xs border-1 rounded-lg border-solid text-md shadow-sm shadow-inset transition-shadow color-black bg-white border-gray-dark)',
