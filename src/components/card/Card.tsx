	...
	return (
		<Comp
			...
			className={classNames(
				'layer-components:(flex flex-col items-start gap-1 transition pb-2 flex-1 min-h-100px bg-transparent border-none text-start text-inherit text-sm relative z-1 p-0 font-sans)',
