...
const colors = {
	...
	default: `layer-variants:[&.btn-color-default]:([--bg:var(--color-white)] [--hover:var(--color-gray-3)] [--focus:var(--color-gray-5)] [--active:var(--color-gray-4)] shadow-sm color-black border-black)`,
