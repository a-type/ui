...
## Map existing styles to Arbor CSS layers
...
Use the Arbor CLI to validate any CSS files you write or edit. You can pass the file path to `npx arbor validate` as a parameter, and it will check that all tokens are valid.
